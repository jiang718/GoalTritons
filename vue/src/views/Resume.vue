  ...
  <div>
    ...
    <div>
      ...
      <div>
        ...
        <p>Now that you have built your Resume, let’s use some Action Verbs to show your skills! </p>
        <img src="../assets/verb1.png" width="500px">
        <img src="../assets/verb2.png" width="500px">
        <br>

        <p>Accomplishment/Impact Statements</p>
        ...
        <p>Sample Sentence Structures:</p>
        <ul>
    ...
    <div>
      ...
      <div>
        ...
        <p>Optional Sections to Include (if you have one)</p>
        <ul>
